...
<div id="wrapper">
  <header id="header" class="clearfix">
    <?php if (theme_get_setting('image_logo','impact_theme')): ?>
      <?php if ($logo): ?><div id="site-logo"><a class="logosite"><!--a href="<?php #print $front_page; ?>" title="<?php #print t('Home'); ?>"-->
...
<div class="footr">
	<div class="cpright">
		       Copyright © <script type="text/javascript">
                ...
                </script> - ARCHIPELAGO<br/>
                <a style="display:inline !important;" href="./archipelago-sitemap">Sitemap</a> | 
				<a style="display:inline !important;" href="./archipelago-privacy-policy">Privacy Policy </a> |
				<a style="display:inline !important;" href="./archipelago-copyright-notice">Copyright Notice</a>
	</div>
	<div class="footrfb">
	<a class="faceb" href="http://www.facebook.com/FastCatOfficial" title="facebook"></a>
	</div>
</div>
</center>
